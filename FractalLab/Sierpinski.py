...
Sierpinski.py: Implementation of the Sierpinski Set as a subclass of Fractal."""
...
class Sierpinski(Fractal):
    ...
    def __init__(self, width: int, height: int, xmin: float,
        ...
        """Constructor for the Sierpinski Set fractal class.
...
if __name__ == '__main__':
    ...
    sierpinski_test: Sierpinski = \
        Sierpinski(width=width, height=height, xmin=xmin,
                   xmax=xmax, ymin=ymin, ymax=ymax)
    sierpinski_test.animate(iterations=100, cmap=cmap, xmin=xmin,
